...
function HomePage() {
  ...
  useEffect(() => {
    getAllProducts();
    // addDataToCollection function is required to be executed during first mount only. This function store data as collection in firebase. After first render we can comment it.
    addDataToCollection();
  }, []);
